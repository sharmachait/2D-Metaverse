...
class SpaceControllerTest {
  ...
  void userIsNotAbleToCreateSpaceWithoutMapIdAndDimensions() {
    ...
    HttpClientErrorException exception = assertThrows(HttpClientErrorException.class, () -> {
      restTemplate.postForEntity(url, request, SpaceDto.class);
  ...
  void userIsNotAbleToDeleteASpaceThatDoesntExist() {
    // arrange
    String url = "http://localhost:" + serverPort + "/api/v1/space" + "/randombullshitassid";
    headers = new HttpHeaders();
    headers.setContentType(MediaType.APPLICATION_JSON);
    headers.add("Authorization", "Bearer " + userToken);
    ...
    HttpClientErrorException exception = assertThrows(HttpClientErrorException.class, () -> {
      restTemplate.exchange(url, HttpMethod.DELETE, request, SpaceDto.class);
    });
  ...
  void userIsNotAbleToDeleteASpaceThatIsNotHis() {
    ...
    String deleteurl = "http://localhost:" + serverPort + "/api/v1/space//" + space2Id;
    headers = new HttpHeaders();
    headers.setContentType(MediaType.APPLICATION_JSON);
    headers.add("Authorization", "Bearer " + userToken);
  ...
  void getAdminSpace() {
    ...
    String Spaceurl = "http://localhost:" + serverPort + "/api/v1/space/" + spacedto.getBody().getId();
    HttpEntity<String> request = new HttpEntity<>(headers);
    // act
  ...
  void getMap() {
    ...
    headers.setContentType(MediaType.APPLICATION_JSON);
    // arrange
    String mapUrl = "http://localhost:" + serverPort + "/api/v1/admin/map/" + mapId;
